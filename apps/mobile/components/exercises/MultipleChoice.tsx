    ...
    <ScrollView className="flex-1 px-4 py-6">
      <View className="space-y-6">
        ...
        <View className="space-y-2">
          <Text className="text-muted-foreground text-sm font-medium">Question</Text>
          <Text className="text-foreground text-xl font-semibold">{config.question}</Text>
        </View>
              ...
              <TouchableOpacity
                ...
                <View className="flex-row items-center justify-between">
                  ...
                  {!submitted && isSelected && (
                    <View className="ml-3 h-5 w-5 rounded-full bg-blue-500" />
                  )}
                  {!submitted && !isSelected && (
                    <View className="ml-3 h-5 w-5 rounded-full border-2 border-gray-300 dark:border-gray-600" />
                  )}
                </View>
              </TouchableOpacity>
            );
        ...
        {submitted && config.explanation && (
          <Animated.View
            entering={FadeIn}
            className="space-y-2 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-950">
