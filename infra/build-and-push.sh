...
echo -e "  • Step 9.3 — Create Cloud SQL PostgreSQL instance"
echo -e "  • Step 9.4 — Store secrets in Secret Manager"
echo -e "  • Step 9.5 — Create VPC Connector"
echo -e "  • Step 9.6 — Deploy API to Cloud Run (use image tag: ${GIT_SHA})"
echo ""
